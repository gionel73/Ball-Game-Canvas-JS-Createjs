class GameEngine {
    ...
    load() {
        ...
        this.top3.graphics.beginFill("#F95100").drawRect(300, 0, 300, 20);
        ...
        this.ball.stepX = 2;
        this.ball.stepY = 6;
        this.ball.dirX = Math.floor(Math.random() * 7) - 3;
        this.ball.dirY = -1;
    ...
    collision(px, py, r, sx, sy, dx, dy) {
        ...
        if (dx < 0 && px - r + sx * dx <= 0) {
            gGameEngine.ball.dirX = -dx;
        }
        if (dx > 0 && px + r + sx * dx >= gGameEngine.cw) {
            gGameEngine.ball.dirX = -dx;
        }

        // Collision top
        if (dy < 0 && py - r + sy * dy <= 20) {
        ...
        // Collision Bottom
        if (dy > 0 && py + r + sy * dy >= gGameEngine.ch - 20) {
            gGameEngine.ball.dirY = -dy;
            if (px < 300) {
                gGameEngine.scoreT -= 10;
            } else if (px < 600) {
    ...
    update() {
        ...
        if (gGameEngine.end) {
            ...
            gGameEngine.collision(gGameEngine.stage.getChildByName("ball").x, gGameEngine.stage.getChildByName("ball").y, 15, gGameEngine.ball.stepX, gGameEngine.ball.stepY, gGameEngine.ball.dirX, gGameEngine.ball.dirY);
